...
const ModalId = () => {
    return (
        <div>
            <div>
                <input type="checkbox" id="tw-modal-id" class="peer fixed apparence-none opacity-0" />
                <label for="tw-modal-id" class="pointer-events-none invisible fixed inset-0 flex cursor-pointer items-center justify-center overflow-hidden overscroll-contain bg-slate-700/30 opacity-0 transition-all duration-200 ease-in-out peer-checked:pointer-events-auto peer-checked:visible peer-checked:opacity-100 peer-checked:[&>*]:translate-y-0 peer-checked:[&>*]:scale-100">
