...
const ModalAbonarVencidos = () => {
    return (
        <div>
            <input type="checkbox" id="tw-modal-abonar-vencidos" class="peer fixed apparence-none opacity-0" />
            <label for="tw-modal-abonar-vencidos" class="pointer-events-none invisible fixed inset-0 flex cursor-pointer items-center justify-center overflow-hidden overscroll-contain bg-slate-700/30 opacity-0 transition-all duration-200 ease-in-out peer-checked:pointer-events-auto peer-checked:visible peer-checked:opacity-100 peer-checked:[&>*]:translate-y-0 peer-checked:[&>*]:scale-100">
                <label class="max-h-[calc(100vh - 5em) h-fit w-[500px] scale-90 overflow-y-auto overscroll-contain rounded-md bg-white p-6 text-black shadow-2xl transition]" for="">
                    ...
                    <div className='mb-5'>
                        <div className='mb-4'>
                            <label for="nombre" class="block mb-2 text-sm font-semibold text-gray-700">Intereses</label>
                        ...
                        <div className='mb-4'>
                            <label for="nombre" class="block mb-2 text-sm font-semibold text-gray-700">Interés Acumulado</label>
...
export default ModalAbonarVencidos