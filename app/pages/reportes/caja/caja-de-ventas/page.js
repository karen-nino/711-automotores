                            ...
                            <section className='mt-10 ml-5 mb-44'>
                                ...
                                <div className='mb-8'>
                                    ...
                                    <div className='flex gap-4'>
                                        <Link href="./caja-de-ventas/flujo-de-caja" className='flex flex-col items-center justify-center w-56 gap-2 text-center bg-white border-2 border-blue-400 border-solid h-28'>
                                        ...
                                        <Link href="./caja-de-ventas/resumen-de-caja" className='flex flex-col items-center justify-center w-56 gap-2 text-center bg-white border-2 border-blue-400 border-solid h-28'>
