...
import ModalAbonar from '@/app/components/modal/modal-abonar/page'
import ModalLiquidar from '@/app/components/modal/modal-liquidar/page'
import ModalAbonarVencidos from '@/app/components/modal/modal-abonar/vencidos/page'

const DetallesPrestamoVencidos = () => {
    return (
        <div>
                                    ...
                                    <defs>
                                        <clipPath id="clip0_371_993">
                                            <rect width="28" height="18.6667" fill="white" />
                                                ...
                                                <label for="tw-modal-abonar-vencidos">Abonar</label>
                                                < ModalAbonarVencidos />
                                            </a>
                                        </li>
                                        <li>
...
export default DetallesPrestamoVencidos